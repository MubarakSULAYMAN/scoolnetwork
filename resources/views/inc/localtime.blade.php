    ...
    <div class="row justify-content-center"> -->
        <div class="col">
            <script type="text/javascript">
                ...
                {
                    greeting = 'Good Morning <i class="fas fa-coffee dawn"></i> and Welcome, we are opened for the day.';
                }

                else if (hourNow == 12 || hourNow < 17)
                {
                    greeting = 'Good Afternoon <i class="fas fa-sun noon"></i> and Welcome, we are still opened for th day.';
                }

                else if (hourNow == 17 || hourNow < 18)
                {
                    greeting = 'Good Evening <i class="fas fa-sun noon"></i> and Welcome, we are closed for today.';
                }

                else if (hourNow == 18 || hourNow < 21)
                {
                    greeting = 'Good Evening <i class="fas fa-moon dusk"></i> and Welcome, you can get back to us tomorrow. ';
                }

                else
                {
                    greeting = 'Welcome! We are here for you but unfortunately, it is not business hours. ';
                }
